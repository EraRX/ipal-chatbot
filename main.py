...
st.markdown(
    ...
    <style>
      ...
      /* Sidebar en hamburger verborgen */
...
DEFAULT_STATE = {
    ...
    "chat_results": [],
    "chat_greeted": False,
    # NIEUW: expliciete actie-balk context
...
def render_chat():
    ...
    # Altijd de actie-balk renderen op basis van expliciete state (niet van het laatste chatbericht)
    _render_actionbar()
